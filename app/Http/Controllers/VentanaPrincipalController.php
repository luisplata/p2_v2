...
class VentanaPrincipalController extends Controller {
    ...
    public function index() {
        ...
        /*
          ...
          //dd($ac);
          foreach ($ac as $cubiculoAsignado) {
          echo "<br/>";
          echo $cubiculoAsignado->paciente->nombre;
          echo "<br/>";
          //echo $cubiculoAsignado->paciente->tratamientos;
          foreach ($cubiculoAsignado->paciente->tratamientos as $medicamento) {
